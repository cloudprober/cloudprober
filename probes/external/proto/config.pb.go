...
func file_github_com_cloudprober_cloudprober_probes_external_proto_config_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_github_com_cloudprober_cloudprober_probes_external_proto_config_proto_msgTypes[4].Exporter = func(v interface{}, i int) interface{} {
		...
		file_github_com_cloudprober_cloudprober_probes_external_proto_config_proto_msgTypes[5].Exporter = func(v interface{}, i int) interface{} {
