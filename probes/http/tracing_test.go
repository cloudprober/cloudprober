...
func runTracedProbe(t *testing.T, tracingEnabled bool) (gotTraceparent string, spans tracetest.SpanStubs) {
	t.Helper()
...
func TestProbeTracingEnabled(t *testing.T) {
	gotTraceparent, spans := runTracedProbe(t, true)
...
func TestProbeTracingDisabled(t *testing.T) {
	gotTraceparent, spans := runTracedProbe(t, false)
