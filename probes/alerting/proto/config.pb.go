...
type PagerDuty struct {
	...
	Enabled bool `protobuf:"varint,1,opt,name=enabled,proto3" json:"enabled,omitempty"` // Default: false
	...
	RoutingKeyEnvVar string `protobuf:"bytes,3,opt,name=routing_key_env_var,json=routingKeyEnvVar,proto3" json:"routing_key_env_var,omitempty"` // Default: PAGERDUTY_ROUTING_KEY;
	// PagerDuty API URL.
	// Used to overwrite the default PagerDuty API URL.
	ApiUrl string `protobuf:"bytes,4,opt,name=api_url,json=apiUrl,proto3" json:"api_url,omitempty"` // Default: https://event.pagerduty.com
}
...
var file_github_com_cloudprober_cloudprober_probes_alerting_proto_config_proto_rawDesc = []byte{
	...
	0x6c, 0x5f, 0x73, 0x65, 0x63, 0x22, 0x8e, 0x01, 0x0a, 0x09, 0x50, 0x61, 0x67, 0x65, 0x72, 0x44,
	...
	0x76, 0x5f, 0x76, 0x61, 0x72, 0x18, 0x03, 0x20, 0x01, 0x28, 0x09, 0x52, 0x10, 0x72, 0x6f, 0x75,
	...
	0x61, 0x70, 0x69, 0x55, 0x72, 0x6c, 0x42, 0x3a, 0x5a, 0x38, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62,
