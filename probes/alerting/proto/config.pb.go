...
type NotifyConfig struct {
	...
	// PagerDuty.
	Pagerduty bool `protobuf:"varint,31,opt,name=pagerduty,proto3" json:"pagerduty,omitempty"` // Default: false
	// PagerDuty URL.
	PagerdutyUrl string `protobuf:"bytes,32,opt,name=pagerduty_url,json=pagerdutyUrl,proto3" json:"pagerduty_url,omitempty"` // Default: https://api.pagerduty.com
	// PagerDuty API Token.
	...
	PagerdutyApiToken string `protobuf:"bytes,33,opt,name=pagerduty_api_token,json=pagerdutyApiToken,proto3" json:"pagerduty_api_token,omitempty"`
	// PagerDuty routing key.
	// PagerDuty routing key can also be set using the environment variable:
	// PAGERDUTY_ROUTING_KEY.
	// The environment variable takes precedence over this field.
	PagerdutyRoutingKey string `protobuf:"bytes,34,opt,name=pagerduty_routing_key,json=pagerdutyRoutingKey,proto3" json:"pagerduty_routing_key,omitempty"`
}
...
func (x *NotifyConfig) GetPagerduty() bool {
	if x != nil {
		return x.Pagerduty
	}
	return false
...
func (x *NotifyConfig) GetPagerdutyUrl() string {
	if x != nil {
		return x.PagerdutyUrl
	}
	return ""
}

func (x *NotifyConfig) GetPagerdutyApiToken() string {
	if x != nil {
		return x.PagerdutyApiToken
	}
	return ""
}
...
var file_github_com_cloudprober_cloudprober_probes_alerting_proto_config_proto_rawDesc = []byte{
	...
	0x74, 0x69, 0x6e, 0x67, 0x22, 0x84, 0x02, 0x0a, 0x0c, 0x4e, 0x6f, 0x74, 0x69, 0x66, 0x79, 0x43,
	...
	,
	...
	0x6c, 0x5f, 0x73, 0x65, 0x63, 0x42, 0x3a, 0x5a, 0x38, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62, 0x2e,
