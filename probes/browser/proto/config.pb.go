...
type CleanupOptions struct {
	...
	MaxArtifacts *int32 `protobuf:"varint,1,opt,name=max_artifacts,json=maxArtifacts" json:"max_artifacts,omitempty"`
	// Maximum age of artifacts in seconds.
	MaxAgeSec *int32 `protobuf:"varint,2,opt,name=max_age_sec,json=maxAgeSec" json:"max_age_sec,omitempty"`
	// Cleanup interval in seconds. Default is 1 hour.
...
func (x *CleanupOptions) GetMaxArtifacts() int32 {
	if x != nil && x.MaxArtifacts != nil {
		return *x.MaxArtifacts
	}
	return 0
}
...
type ProbeConf struct {
	...
	SaveScreenshotsForSuccess *bool `protobuf:"varint,5,opt,name=save_screenshots_for_success,json=saveScreenshotsForSuccess,def=0" json:"save_screenshots_for_success,omitempty"`
	// Traces are expensive and can slow down the test. We recommend to enable
	// this only when needed.
	SaveTraces *bool `protobuf:"varint,6,opt,name=save_traces,json=saveTraces,def=0" json:"save_traces,omitempty"`
	...
	// Cleanup options.
	WorkdirCleanupOptions *CleanupOptions `protobuf:"bytes,9,opt,name=workdir_cleanup_options,json=workdirCleanupOptions" json:"workdir_cleanup_options,omitempty"`
	// Requests per probe.
...
var file_github_com_cloudprober_cloudprober_probes_browser_proto_config_proto_rawDesc = []byte{
	...
	0x07, 0x73, 0x74, 0x6f, 0x72, 0x61, 0x67, 0x65, 0x22, 0x8d, 0x01, 0x0a, 0x0e, 0x43, 0x6c, 0x65,
	0x61, 0x6e, 0x75, 0x70, 0x4f, 0x70, 0x74, 0x69, 0x6f, 0x6e, 0x73, 0x12, 0x23, 0x0a, 0x0d, 0x6d,
	0x61, 0x78, 0x5f, 0x61, 0x72, 0x74, 0x69, 0x66, 0x61, 0x63, 0x74, 0x73, 0x18, 0x01, 0x20, 0x01,
	0x28, 0x05, 0x52, 0x0c, 0x6d, 0x61, 0x78, 0x41, 0x72, 0x74, 0x69, 0x66, 0x61, 0x63, 0x74, 0x73,
	0x12, 0x1e, 0x0a, 0x0b, 0x6d, 0x61, 0x78, 0x5f, 0x61, 0x67, 0x65, 0x5f, 0x73, 0x65, 0x63, 0x18,
	0x02, 0x20, 0x01, 0x28, 0x05, 0x52, 0x09, 0x6d, 0x61, 0x78, 0x41, 0x67, 0x65, 0x53, 0x65, 0x63,
	...
	0x65, 0x72, 0x76, 0x61, 0x6c, 0x53, 0x65, 0x63, 0x22, 0x97, 0x05, 0x0a, 0x09, 0x50, 0x72, 0x6f,
	...
	,
	...
	,
	...
	0x65, 0x63, 0x42, 0x39, 0x5a, 0x37, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62, 0x2e, 0x63, 0x6f, 0x6d,
	...
	0x62, 0x72, 0x6f, 0x77, 0x73, 0x65, 0x72, 0x2f, 0x70, 0x72, 0x6f, 0x74, 0x6f,
}
...
var file_github_com_cloudprober_cloudprober_probes_browser_proto_config_proto_msgTypes = make([]protoimpl.MessageInfo, 6)
var file_github_com_cloudprober_cloudprober_probes_browser_proto_config_proto_goTypes = []any{
	...
	(*CleanupOptions)(nil),     // 4: cloudprober.probes.browser.CleanupOptions
	(*ProbeConf)(nil),          // 5: cloudprober.probes.browser.ProbeConf
}
var file_github_com_cloudprober_cloudprober_probes_browser_proto_config_proto_depIdxs = []int32{
	...
	4, // 4: cloudprober.probes.browser.ProbeConf.workdir_cleanup_options:type_name -> cloudprober.probes.browser.CleanupOptions
...
func file_github_com_cloudprober_cloudprober_probes_browser_proto_config_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_github_com_cloudprober_cloudprober_probes_browser_proto_config_proto_msgTypes[5].Exporter = func(v any, i int) any {
