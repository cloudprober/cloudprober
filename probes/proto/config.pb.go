...
type ProbeDef struct {
	...
	// to 1 minute.
	ReEvalSec *int32 `protobuf:"varint,103,opt,name=re_eval_sec,json=reEvalSec" json:"re_eval_sec,omitempty"`
...
func (x *ProbeDef) GetReEvalSec() int32 {
...
const file_github_com_cloudprober_cloudprober_probes_proto_config_proto_rawDesc = "" +
	...
	"\x06run_on\x18\x03 \x01(\tR\x05runOn\x12\x1e\n" +
	"\vre_eval_sec\x18g \x01(\x05R\treEvalSec\x12,\n" +
