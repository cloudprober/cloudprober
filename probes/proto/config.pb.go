...
import (
	...
	proto14 "github.com/cloudprober/cloudprober/probes/script/proto"
...
const (
	...
	ProbeDef_SCRIPT       ProbeDef_Type = 10
...
type ProbeDef struct {
	...
	// to 1 minute.
	TargetsUpdateSec *int32 `protobuf:"varint,103,opt,name=targets_update_sec,json=targetsUpdateSec" json:"targets_update_sec,omitempty"`
...
func (x *ProbeDef) GetSystemProbe() *proto13.ProbeConf {
	if x != nil {
		if x, ok := x.Probe.(*ProbeDef_SystemProbe); ok {
...
func (x *ProbeDef) GetScriptProbe() *proto14.ProbeConf {
	if x != nil {
		if x, ok := x.Probe.(*ProbeDef_ScriptProbe); ok {
			return x.ScriptProbe
		}
	}
	return nil
}
...
func (x *ProbeDef) GetTargetsUpdateSec() int32 {
	if x != nil && x.TargetsUpdateSec != nil {
		return *x.TargetsUpdateSec
	}
	return 0
}
...
type ProbeDef_ScriptProbe struct {
	ScriptProbe *proto14.ProbeConf `protobuf:"bytes,30,opt,name=script_probe,json=scriptProbe,oneof"`
}
...
func (*ProbeDef_ScriptProbe) isProbeDef_Probe() {}
...
const file_github_com_cloudprober_cloudprober_probes_proto_config_proto_rawDesc = "" +
	"\n" +
	"<github.com/cloudprober/cloudprober/probes/proto/config.proto\x12\x12cloudprober.probes\x1a;github.com/cloudprober/cloudprober/metrics/proto/dist.proto\x1aGgithub.com/cloudprober/cloudprober/internal/alerting/proto/config.proto\x1aDgithub.com/cloudprober/cloudprober/probes/browser/proto/config.proto\x1a@github.com/cloudprober/cloudprober/probes/dns/proto/config.proto\x1aEgithub.com/cloudprober/cloudprober/probes/external/proto/config.proto\x1aAgithub.com/cloudprober/cloudprober/probes/grpc/proto/config.proto\x1aAgithub.com/cloudprober/cloudprober/probes/http/proto/config.proto\x1aAgithub.com/cloudprober/cloudprober/probes/ping/proto/config.proto\x1aCgithub.com/cloudprober/cloudprober/probes/script/proto/config.proto\x1a@github.com/cloudprober/cloudprober/probes/tcp/proto/config.proto\x1a@github.com/cloudprober/cloudprober/probes/udp/proto/config.proto\x1aHgithub.com/cloudprober/cloudprober/probes/udplistener/proto/config.proto\x1aCgithub.com/cloudprober/cloudprober/probes/system/proto/config.proto\x1a>github.com/cloudprober/cloudprober/targets/proto/targets.proto\x1aIgithub.com/cloudprober/cloudprober/internal/validators/proto/config.proto\"\xcf\x11\n" +
	"\bProbeDef\x12\x12\n" +
	"\x04name\x18\x01 \x02(\tR\x04name\x125\n" +
	"\x04type\x18\x02 \x02(\x0e2!.cloudprober.probes.ProbeDef.TypeR\x04type\x12#\n" +
	"\rinterval_msec\x18\x04 \x01(\x05R\fintervalMsec\x12\x1a\n" +
	"\binterval\x18\x10 \x01(\tR\binterval\x12!\n" +
	"\ftimeout_msec\x18\x05 \x01(\x05R\vtimeoutMsec\x12\x18\n" +
	"\atimeout\x18\x11 \x01(\tR\atimeout\x129\n" +
	"\atargets\x18\x06 \x01(\v2\x1f.cloudprober.targets.TargetsDefR\atargets\x12L\n" +
	"\x14latency_distribution\x18\a \x01(\v2\x19.cloudprober.metrics.DistR\x13latencyDistribution\x12%\n" +
	"\flatency_unit\x18\b \x01(\t:\x02usR\vlatencyUnit\x127\n" +
	"\x13latency_metric_name\x18\x0f \x01(\t:\alatencyR\x11latencyMetricName\x12?\n" +
	"\tvalidator\x18\t \x03(\v2!.cloudprober.validators.ValidatorR\tvalidator\x12\x1d\n" +
	"\tsource_ip\x18\n" +
	" \x01(\tH\x00R\bsourceIp\x12+\n" +
	"\x10source_interface\x18\v \x01(\tH\x00R\x0fsourceInterface\x12E\n" +
	"\n" +
	...
	"\n" +
	"ping_probe\x18\x14 \x01(\v2\".cloudprober.probes.ping.ProbeConfH\x01R\tpingProbe\x12C\n" +
	"\n" +
	"http_probe\x18\x15 \x01(\v2\".cloudprober.probes.http.ProbeConfH\x01R\thttpProbe\x12@\n" +
	"\tdns_probe\x18\x16 \x01(\v2!.cloudprober.probes.dns.ProbeConfH\x01R\bdnsProbe\x12O\n" +
	"\x0eexternal_probe\x18\x17 \x01(\v2&.cloudprober.probes.external.ProbeConfH\x01R\rexternalProbe\x12@\n" +
	"\tudp_probe\x18\x18 \x01(\v2!.cloudprober.probes.udp.ProbeConfH\x01R\budpProbe\x12Y\n" +
	"\x12udp_listener_probe\x18\x19 \x01(\v2).cloudprober.probes.udplistener.ProbeConfH\x01R\x10udpListenerProbe\x12C\n" +
	"\n" +
	"grpc_probe\x18\x1a \x01(\v2\".cloudprober.probes.grpc.ProbeConfH\x01R\tgrpcProbe\x12@\n" +
	...
	"\fsystem_probe\x18\x1d \x01(\v2$.cloudprober.probes.system.ProbeConfH\x01R\vsystemProbe\x12I\n" +
	"\fscript_probe\x18\x1e \x01(\v2$.cloudprober.probes.script.ProbeConfH\x01R\vscriptProbe\x12.\n" +
	...
	"\rdebug_options\x18d \x01(\v2 .cloudprober.probes.DebugOptionsR\fdebugOptions\"\xa5\x01\n" +
	"\x04Type\x12\b\n" +
	"\x04PING\x10\x00\x12\b\n" +
	"\x04HTTP\x10\x01\x12\a\n" +
	"\x03DNS\x10\x02\x12\f\n" +
	"\bEXTERNAL\x10\x03\x12\a\n" +
	"\x03UDP\x10\x04\x12\x10\n" +
	"\fUDP_LISTENER\x10\x05\x12\b\n" +
	"\x04GRPC\x10\x06\x12\a\n" +
	"\x03TCP\x10\a\x12\v\n" +
	"\aBROWSER\x10\b\x12\n" +
	"\n" +
	"\x06SYSTEM\x10\t\x12\n" +
	...
	"\x04IPV6\x10\x02*\t\b\xc8\x01\x10\x80\x80\x80\x80\x02B\x12\n" +
	"\x10source_ip_configB\a\n" +
	"\x05probe\"9\n" +
	"\x0fAdditionalLabel\x12\x10\n" +
	"\x03key\x18\x01 \x02(\tR\x03key\x12\x14\n" +
	"\x05value\x18\x02 \x02(\tR\x05value\"\x94\x04\n" +
	"\bSchedule\x12=\n" +
	"\x04type\x18\x01 \x02(\x0e2).cloudprober.probes.Schedule.ScheduleTypeR\x04type\x12S\n" +
	"\rstart_weekday\x18\x02 \x01(\x0e2$.cloudprober.probes.Schedule.Weekday:\bEVERYDAYR\fstartWeekday\x12$\n" +
	"\n" +
	"start_time\x18\x03 \x01(\t:\x0500:00R\tstartTime\x12O\n" +
	"\vend_weekday\x18\x04 \x01(\x0e2$.cloudprober.probes.Schedule.Weekday:\bEVERYDAYR\n" +
	"endWeekday\x12 \n" +
	"\bend_time\x18\x05 \x01(\t:\x0523:59R\aendTime\x12\x1f\n" +
	"\btimezone\x18\x06 \x01(\t:\x03UTCR\btimezone\"s\n" +
	"\aWeekday\x12\f\n" +
	"\bEVERYDAY\x10\x00\x12\n" +
	"\n" +
	...
	"\bSATURDAY\x10\a\"E\n" +
	"\fScheduleType\x12\x1c\n" +
	"\x18ScheduleType_UNSPECIFIED\x10\x00\x12\n" +
	"\n" +
	"\x06ENABLE\x10\x01\x12\v\n" +
	"\aDISABLE\x10\x02\"/\n" +
	"\fDebugOptions\x12\x1f\n" +
	"\vlog_metrics\x18\x01 \x01(\bR\n" +
	"logMetricsB1Z/github.com/cloudprober/cloudprober/probes/proto"
...
var file_github_com_cloudprober_cloudprober_probes_proto_config_proto_goTypes = []any{
	...
	(*proto14.ProbeConf)(nil),  // 22: cloudprober.probes.script.ProbeConf
}
var file_github_com_cloudprober_cloudprober_probes_proto_config_proto_depIdxs = []int32{
	...
	22, // 17: cloudprober.probes.ProbeDef.script_probe:type_name -> cloudprober.probes.script.ProbeConf
