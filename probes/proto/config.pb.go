...
var file_github_com_cloudprober_cloudprober_probes_proto_config_proto_rawDesc = string([]byte{
...
var (
	...
	file_github_com_cloudprober_cloudprober_probes_proto_config_proto_rawDescData []byte
)
...
func file_github_com_cloudprober_cloudprober_probes_proto_config_proto_rawDescGZIP() []byte {
	file_github_com_cloudprober_cloudprober_probes_proto_config_proto_rawDescOnce.Do(func() {
		file_github_com_cloudprober_cloudprober_probes_proto_config_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_github_com_cloudprober_cloudprober_probes_proto_config_proto_rawDesc), len(file_github_com_cloudprober_cloudprober_probes_proto_config_proto_rawDesc)))
	})
...
func file_github_com_cloudprober_cloudprober_probes_proto_config_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_github_com_cloudprober_cloudprober_probes_proto_config_proto_rawDesc), len(file_github_com_cloudprober_cloudprober_probes_proto_config_proto_rawDesc)),
			NumEnums:      4,
			NumMessages:   4,
			NumExtensions: 0,
			NumServices:   0,
