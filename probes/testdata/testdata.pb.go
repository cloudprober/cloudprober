...
var file_github_com_cloudprober_cloudprober_probes_testdata_testdata_proto_goTypes = []interface{}{
...
func file_github_com_cloudprober_cloudprober_probes_testdata_testdata_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_github_com_cloudprober_cloudprober_probes_testdata_testdata_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_github_com_cloudprober_cloudprober_probes_testdata_testdata_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
