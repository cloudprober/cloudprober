...
const file_github_com_cloudprober_cloudprober_config_proto_config_proto_rawDesc = "" +
	...
	"\x06server\x18\x03 \x03(\v2\x1e.cloudprober.servers.ServerDefR\x06server\x12A\n" +
	"\x0eshared_targets\x18\x04 \x03(\v2\x1a.cloudprober.SharedTargetsR\rsharedTargets\x12:\n" +
	"\n" +
	"rds_server\x18_ \x01(\v2\x1b.cloudprober.rds.ServerConfR\trdsServer\x12\x12\n" +
	"\x04port\x18` \x01(\x05R\x04port\x12\x1b\n" +
	"\tgrpc_port\x18h \x01(\x05R\bgrpcPort\x12H\n" +
	"\x0fgrpc_tls_config\x18i \x01(\v2 .cloudprober.tlsconfig.TLSConfigR\rgrpcTlsConfig\x12\x12\n" +
	"\x04host\x18e \x01(\tR\x04host\x12,\n" +
	"\x0edisable_jitter\x18f \x01(\b:\x05falseR\rdisableJitter\x129\n" +
	"\x15sysvars_interval_msec\x18a \x01(\x05:\x0510000R\x13sysvarsIntervalMsec\x12/\n" +
	...
	"\x0fSurfacersConfig\x12=\n" +
	"\bsurfacer\x18\x01 \x03(\v2!.cloudprober.surfacer.SurfacerDefR\bsurfacerB1Z/github.com/cloudprober/cloudprober/config/proto"
