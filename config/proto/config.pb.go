...
type ProberConfig struct {
	...
	// Probes to run.
	Probe []*proto.ProbeDef `protobuf:"bytes,1,rep,name=probe,proto3" json:"probe,omitempty"`
	...
	//
	//	surfacer {}
	Surfacer []*proto1.SurfacerDef `protobuf:"bytes,2,rep,name=surfacer,proto3" json:"surfacer,omitempty"`
	// Servers to run inside cloudprober. These servers can serve as targets for
	// other probes.
	Server []*proto2.ServerDef `protobuf:"bytes,3,rep,name=server,proto3" json:"server,omitempty"`
	...
	//	  }
	//	}
	SharedTargets []*SharedTargets `protobuf:"bytes,4,rep,name=shared_targets,json=sharedTargets,proto3" json:"shared_targets,omitempty"`
	// Resource discovery server
	RdsServer *proto3.ServerConf `protobuf:"bytes,95,opt,name=rds_server,json=rdsServer,proto3" json:"rds_server,omitempty"`
	...
	// CLOUDPROBER_PORT.
	Port int32 `protobuf:"varint,96,opt,name=port,proto3" json:"port,omitempty"`
	...
	GrpcPort int32 `protobuf:"varint,104,opt,name=grpc_port,json=grpcPort,proto3" json:"grpc_port,omitempty"`
	...
	//     tls_key_file: "..."
	//     }
	GrpcTlsConfig *proto4.TLSConfig `protobuf:"bytes,105,opt,name=grpc_tls_config,json=grpcTlsConfig,proto3" json:"grpc_tls_config,omitempty"`
	...
	Host *string `protobuf:"bytes,101,opt,name=host,proto3,oneof" json:"host,omitempty"`
	...
	// to true.
	DisableJitter bool `protobuf:"varint,102,opt,name=disable_jitter,json=disableJitter,proto3" json:"disable_jitter,omitempty"`
	...
	// Default is 10s.
	SysvarsIntervalMsec int32 `protobuf:"varint,97,opt,name=sysvars_interval_msec,json=sysvarsIntervalMsec,proto3" json:"sysvars_interval_msec,omitempty"`
	...
	// Default: "SYSVARS"
	SysvarsEnvVar string `protobuf:"bytes,98,opt,name=sysvars_env_var,json=sysvarsEnvVar,proto3" json:"sysvars_env_var,omitempty"`
	...
	// Default: 5s
	StopTimeSec *int32 `protobuf:"varint,99,opt,name=stop_time_sec,json=stopTimeSec,proto3,oneof" json:"stop_time_sec,omitempty"`
	// Global targets options. Per-probe options are specified within the probe
	// stanza.
	GlobalTargetsOptions *proto5.GlobalTargetsOptions `protobuf:"bytes,100,opt,name=global_targets_options,json=globalTargetsOptions,proto3" json:"global_targets_options,omitempty"`
}
...
type SharedTargets struct {
	...
	Targets *proto5.TargetsDef `protobuf:"bytes,2,opt,name=targets,proto3" json:"targets,omitempty"`
}
...
var file_github_com_cloudprober_cloudprober_config_proto_config_proto_rawDesc = []byte{
	...
	0x63, 0x6c, 0x6f, 0x75, 0x64, 0x70, 0x72, 0x6f, 0x62, 0x65, 0x72, 0x1a, 0x46, 0x67, 0x69, 0x74,
	...
	0x72, 0x6f, 0x62, 0x65, 0x72, 0x2f, 0x72, 0x64, 0x73, 0x2f, 0x73, 0x65, 0x72, 0x76, 0x65, 0x72,
	0x2f, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x2f, 0x63, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x2e, 0x70, 0x72,
	...
	0x74, 0x6f, 0x1a, 0x3f, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62, 0x2e, 0x63, 0x6f, 0x6d, 0x2f, 0x63,
	...
	,
	...
	0x66, 0x52, 0x07, 0x74, 0x61, 0x72, 0x67, 0x65, 0x74, 0x73, 0x42, 0x31, 0x5a, 0x2f, 0x67, 0x69,
...
var file_github_com_cloudprober_cloudprober_config_proto_config_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_github_com_cloudprober_cloudprober_config_proto_config_proto_goTypes = []interface{}{
	...
	(*proto1.SurfacerDef)(nil),          // 3: cloudprober.surfacer.SurfacerDef
	(*proto2.ServerDef)(nil),            // 4: cloudprober.servers.ServerDef
	(*proto3.ServerConf)(nil),           // 5: cloudprober.rds.ServerConf
	(*proto4.TLSConfig)(nil),            // 6: cloudprober.tlsconfig.TLSConfig
	(*proto5.GlobalTargetsOptions)(nil), // 7: cloudprober.targets.GlobalTargetsOptions
	(*proto5.TargetsDef)(nil),           // 8: cloudprober.targets.TargetsDef
}
...
func file_github_com_cloudprober_cloudprober_config_proto_config_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_github_com_cloudprober_cloudprober_config_proto_config_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_github_com_cloudprober_cloudprober_config_proto_config_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
	...
	file_github_com_cloudprober_cloudprober_config_proto_config_proto_msgTypes[0].OneofWrappers = []interface{}{}
	type x struct{}
