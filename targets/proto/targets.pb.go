...
type TargetsDef struct {
	...
	// Note: all dns_* options are only applicable if you're using Cloudprober's
	// DNS resolver, i.e. you're setting resolve_first probe setting to true.
	...
	// Note: all dns_* options are only applicable if you're using Cloudprober's
	// DNS resolver, i.e. you're setting resolve_first probe setting to true.
	DnsTtlSec *int32 `protobuf:"varint,36,opt,name=dns_ttl_sec,json=dnsTtlSec,def=300" json:"dns_ttl_sec,omitempty"`
	// DNS maximum ttl. This option controls for long cached IP can be used in
	// case of resolve errors. Default value is set to dns_ttl_sec. It should
	// never be lower than dns_ttl_sec.
	// Note: all dns_* options are only applicable if you're using Cloudprober's
	// DNS resolver, i.e. you're setting resolve_first probe setting to true.
	DnsMaxTtlSec *int32 `protobuf:"varint,38,opt,name=dns_max_ttl_sec,json=dnsMaxTtlSec" json:"dns_max_ttl_sec,omitempty"`
	// DNS resolve timeout. This option controls how long we'll wait for the
	// backend DNS server to respond. Note that DNS resolution happens
	...
	// Note: all dns_* options are only applicable if you're using Cloudprober's
	// DNS resolver, i.e. you're setting resolve_first probe setting to true.
	DnsResolveTimeoutSec *int32 `protobuf:"varint,39,opt,name=dns_resolve_timeout_sec,json=dnsResolveTimeoutSec,def=30" json:"dns_resolve_timeout_sec,omitempty"`
}

// Default values for TargetsDef fields.
const (
	Default_TargetsDef_ExcludeLameducks     = bool(true)
	Default_TargetsDef_DnsTtlSec            = int32(300)
	Default_TargetsDef_DnsResolveTimeoutSec = int32(30)
)
...
func (x *TargetsDef) GetDnsTtlSec() int32 {
	if x != nil && x.DnsTtlSec != nil {
		return *x.DnsTtlSec
	}
	return Default_TargetsDef_DnsTtlSec
}

func (x *TargetsDef) GetDnsMaxTtlSec() int32 {
	if x != nil && x.DnsMaxTtlSec != nil {
		return *x.DnsMaxTtlSec
	}
	return 0
}

func (x *TargetsDef) GetDnsResolveTimeoutSec() int32 {
	if x != nil && x.DnsResolveTimeoutSec != nil {
		return *x.DnsResolveTimeoutSec
	}
	return Default_TargetsDef_DnsResolveTimeoutSec
}
...
var file_github_com_cloudprober_cloudprober_targets_proto_targets_proto_rawDesc = []byte{
	...
	,
}
...
var file_github_com_cloudprober_cloudprober_targets_proto_targets_proto_goTypes = []any{
	...
	(*proto3.TargetsConf)(nil),             // 8: cloudprober.targets.gce.TargetsConf
	(*proto4.TargetsConf)(nil),             // 9: cloudprober.targets.file.TargetsConf
	(*proto2.Endpoint)(nil),                // 10: cloudprober.targets.Endpoint
	(*proto3.GlobalOptions)(nil),           // 11: cloudprober.targets.gce.GlobalOptions
	(*proto5.Options)(nil),                 // 12: cloudprober.targets.lameduck.Options
}
var file_github_com_cloudprober_cloudprober_targets_proto_targets_proto_depIdxs = []int32{
	...
	10, // 9: cloudprober.targets.TargetsDef.endpoint:type_name -> cloudprober.targets.Endpoint
	5,  // 10: cloudprober.targets.GlobalTargetsOptions.rds_server_options:type_name -> cloudprober.rds.ClientConf.ServerOptions
	11, // 11: cloudprober.targets.GlobalTargetsOptions.global_gce_targets_options:type_name -> cloudprober.targets.gce.GlobalOptions
	12, // 12: cloudprober.targets.GlobalTargetsOptions.lame_duck_options:type_name -> cloudprober.targets.lameduck.Options
...
func file_github_com_cloudprober_cloudprober_targets_proto_targets_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_github_com_cloudprober_cloudprober_targets_proto_targets_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_github_com_cloudprober_cloudprober_targets_proto_targets_proto_msgTypes[1].Exporter = func(v any, i int) any {
		...
		file_github_com_cloudprober_cloudprober_targets_proto_targets_proto_msgTypes[2].Exporter = func(v any, i int) any {
		...
		file_github_com_cloudprober_cloudprober_targets_proto_targets_proto_msgTypes[3].Exporter = func(v any, i int) any {
		...
		file_github_com_cloudprober_cloudprober_targets_proto_targets_proto_msgTypes[4].Exporter = func(v any, i int) any {
	...
	file_github_com_cloudprober_cloudprober_targets_proto_targets_proto_msgTypes[2].OneofWrappers = []any{
