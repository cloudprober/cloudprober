...
type Validator struct {
	...
	LastModifiedDiffSeconds int64 `protobuf:"varint,5,opt,name=last_modified_diff_seconds,json=lastModifiedDiffSeconds,proto3" json:"last_modified_diff_seconds,omitempty"`
}
...
func (x *Validator) GetLastModifiedDiffSeconds() int64 {
	if x != nil {
...
var file_github_com_cloudprober_cloudprober_validators_http_proto_config_proto_rawDesc = []byte{
	...
	0x6f, 0x6e, 0x64, 0x73, 0x18, 0x05, 0x20, 0x01, 0x28, 0x03, 0x52, 0x17, 0x6c, 0x61, 0x73, 0x74,
