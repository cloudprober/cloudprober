...
func TestGenerateTemplateData(t *testing.T) {
	...
	testProtoPkgs := []string{
		...
		filepath.Join(tempDir, "testpkg", "subpkg3", "proto"),
	}

	testpbgoWithOnlyStruct := `// Code generated by protoc-gen-go. DO NOT EDIT.
package proto
...
`
	...
	testpbgoWithEnum := `// Code generated by protoc-gen-go. DO NOT EDIT.
package proto
...
`
	...
	// Mirrors the compatibility shim in internal/surfacers/otel/proto: a proto
	// package that re-exports messages and enums that have moved to a shared
	// package. These aliases must still show up in the facade.
	testpbgoWithAliases := `package proto

import subpkg2 "testmodule/testpkg/subpkg2/proto"

type AliasedEnum = subpkg2.TestEnum
type AliasedMessage = subpkg2.TestMessage

const AliasedEnum_ONE = subpkg2.TestEnum_ONE
`

	pkgContents := []string{testpbgoWithOnlyStruct, testpbgoWithEnum, testpbgoWithAliases}

	for i, dir := range testProtoPkgs {
		if err := os.MkdirAll(dir, 0755); err != nil {
	...
	}{
		{
			...
			want: &TemplateData{
				...
				Imports: []Import{
					...
					{
						Alias: "subpkg3pb",
						Path:  "testmodule/testpkg/subpkg3/proto",
					},
				},
				ReExportOrder: []string{
					"testmodule/testpkg/subpkg1/proto",
					"testmodule/testpkg/subpkg2/proto",
					"testmodule/testpkg/subpkg3/proto",
				},
				ImportReExports: map[string][]ReExport{
					"testmodule/testpkg/subpkg1/proto": {
						{Alias: "Subpkg1AnotherType", AliasKeyword: "type", Original: "AnotherType", ImportAlias: "subpkg1pb"},
						{Alias: "Subpkg1TestMessage", AliasKeyword: "type", Original: "TestMessage", ImportAlias: "subpkg1pb"},
					},
					"testmodule/testpkg/subpkg2/proto": {
						{Alias: "Subpkg2TestEnum_ONE", AliasKeyword: "const", Original: "TestEnum_ONE", ImportAlias: "subpkg2pb"},
						{Alias: "Subpkg2TestEnum_UNKNOWN", AliasKeyword: "const", Original: "TestEnum_UNKNOWN", ImportAlias: "subpkg2pb"},
						{Alias: "Subpkg2TestEnum", AliasKeyword: "type", Original: "TestEnum", ImportAlias: "subpkg2pb"},
						{Alias: "Subpkg2TestMessage", AliasKeyword: "type", Original: "TestMessage", ImportAlias: "subpkg2pb"},
					},
					"testmodule/testpkg/subpkg3/proto": {
						{Alias: "Subpkg3AliasedEnum_ONE", AliasKeyword: "const", Original: "AliasedEnum_ONE", ImportAlias: "subpkg3pb"},
						{Alias: "Subpkg3AliasedEnum", AliasKeyword: "type", Original: "AliasedEnum", ImportAlias: "subpkg3pb"},
						{Alias: "Subpkg3AliasedMessage", AliasKeyword: "type", Original: "AliasedMessage", ImportAlias: "subpkg3pb"},
					},
				},
			},
			wantErr: false,
