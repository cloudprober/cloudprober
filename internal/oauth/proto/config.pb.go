...
var file_github_com_cloudprober_cloudprober_internal_oauth_proto_config_proto_goTypes = []interface{}{
...
func file_github_com_cloudprober_cloudprober_internal_oauth_proto_config_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_github_com_cloudprober_cloudprober_internal_oauth_proto_config_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*Config); i {
			case 0:
				return &v.state
			case 1:
		...
		file_github_com_cloudprober_cloudprober_internal_oauth_proto_config_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
		...
		file_github_com_cloudprober_cloudprober_internal_oauth_proto_config_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
		...
		file_github_com_cloudprober_cloudprober_internal_oauth_proto_config_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
	...
	file_github_com_cloudprober_cloudprober_internal_oauth_proto_config_proto_msgTypes[0].OneofWrappers = []interface{}{
		(*Config_HttpRequest)(nil),
		(*Config_BearerToken)(nil),
		(*Config_GoogleCredentials)(nil),
	}
	file_github_com_cloudprober_cloudprober_internal_oauth_proto_config_proto_msgTypes[2].OneofWrappers = []interface{}{
