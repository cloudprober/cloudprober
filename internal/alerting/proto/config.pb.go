...
func (x *Opsgenie_Responder) GetId() string {
	if x, ok := x.GetRef().(*Opsgenie_Responder_Id); ok {
		return x.Id
	}
	return ""
}
...
func (x *Opsgenie_Responder) GetName() string {
	if x, ok := x.GetRef().(*Opsgenie_Responder_Name); ok {
		return x.Name
	}
	return ""
}
...
var file_github_com_cloudprober_cloudprober_internal_alerting_proto_config_proto_rawDesc = []byte{
...
var (
	...
	file_github_com_cloudprober_cloudprober_internal_alerting_proto_config_proto_rawDescData = file_github_com_cloudprober_cloudprober_internal_alerting_proto_config_proto_rawDesc
)
...
func file_github_com_cloudprober_cloudprober_internal_alerting_proto_config_proto_rawDescGZIP() []byte {
	file_github_com_cloudprober_cloudprober_internal_alerting_proto_config_proto_rawDescOnce.Do(func() {
		file_github_com_cloudprober_cloudprober_internal_alerting_proto_config_proto_rawDescData = protoimpl.X.CompressGZIP(file_github_com_cloudprober_cloudprober_internal_alerting_proto_config_proto_rawDescData)
	})
...
var file_github_com_cloudprober_cloudprober_internal_alerting_proto_config_proto_goTypes = []interface{}{
...
func file_github_com_cloudprober_cloudprober_internal_alerting_proto_config_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_github_com_cloudprober_cloudprober_internal_alerting_proto_config_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*Email); i {
			case 0:
				return &v.state
			case 1:
		...
		file_github_com_cloudprober_cloudprober_internal_alerting_proto_config_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
		...
		file_github_com_cloudprober_cloudprober_internal_alerting_proto_config_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
		...
		file_github_com_cloudprober_cloudprober_internal_alerting_proto_config_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*Slack); i {
			case 0:
				return &v.state
			case 1:
		...
		file_github_com_cloudprober_cloudprober_internal_alerting_proto_config_proto_msgTypes[4].Exporter = func(v interface{}, i int) interface{} {
		...
		file_github_com_cloudprober_cloudprober_internal_alerting_proto_config_proto_msgTypes[5].Exporter = func(v interface{}, i int) interface{} {
		...
		file_github_com_cloudprober_cloudprober_internal_alerting_proto_config_proto_msgTypes[6].Exporter = func(v interface{}, i int) interface{} {
		...
		file_github_com_cloudprober_cloudprober_internal_alerting_proto_config_proto_msgTypes[7].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*Opsgenie_Responder); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
	...
	file_github_com_cloudprober_cloudprober_internal_alerting_proto_config_proto_msgTypes[6].OneofWrappers = []interface{}{}
	file_github_com_cloudprober_cloudprober_internal_alerting_proto_config_proto_msgTypes[7].OneofWrappers = []interface{}{
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_github_com_cloudprober_cloudprober_internal_alerting_proto_config_proto_rawDesc,
			NumEnums:      2,
			NumMessages:   9,
			NumExtensions: 0,
			NumServices:   0,
	...
	file_github_com_cloudprober_cloudprober_internal_alerting_proto_config_proto_rawDesc = nil
