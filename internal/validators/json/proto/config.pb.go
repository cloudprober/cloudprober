...
var file_github_com_cloudprober_cloudprober_internal_validators_json_proto_config_proto_rawDesc = []byte{
...
var (
	...
	file_github_com_cloudprober_cloudprober_internal_validators_json_proto_config_proto_rawDescData = file_github_com_cloudprober_cloudprober_internal_validators_json_proto_config_proto_rawDesc
)
...
func file_github_com_cloudprober_cloudprober_internal_validators_json_proto_config_proto_rawDescGZIP() []byte {
	file_github_com_cloudprober_cloudprober_internal_validators_json_proto_config_proto_rawDescOnce.Do(func() {
		file_github_com_cloudprober_cloudprober_internal_validators_json_proto_config_proto_rawDescData = protoimpl.X.CompressGZIP(file_github_com_cloudprober_cloudprober_internal_validators_json_proto_config_proto_rawDescData)
	})
...
var file_github_com_cloudprober_cloudprober_internal_validators_json_proto_config_proto_goTypes = []interface{}{
...
func file_github_com_cloudprober_cloudprober_internal_validators_json_proto_config_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_github_com_cloudprober_cloudprober_internal_validators_json_proto_config_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_github_com_cloudprober_cloudprober_internal_validators_json_proto_config_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
	...
	file_github_com_cloudprober_cloudprober_internal_validators_json_proto_config_proto_rawDesc = nil
