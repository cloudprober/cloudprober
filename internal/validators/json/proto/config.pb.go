...
const file_github_com_cloudprober_cloudprober_internal_validators_json_proto_config_proto_rawDesc = "" +
	"\n" +
	"Ngithub.com/cloudprober/cloudprober/internal/validators/json/proto/config.proto\x12\x1bcloudprober.validators.json\"(\n" +
	"\tValidator\x12\x1b\n" +
	"\tjq_filter\x18\x01 \x01(\tR\bjqFilterBCZAgithub.com/cloudprober/cloudprober/internal/validators/json/protob\x06proto3"
