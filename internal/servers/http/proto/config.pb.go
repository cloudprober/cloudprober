...
const file_github_com_cloudprober_cloudprober_internal_servers_http_proto_config_proto_rawDesc = "" +
	"\n" +
	"Kgithub.com/cloudprober/cloudprober/internal/servers/http/proto/config.proto\x12\x18cloudprober.servers.http\"\xe7\x04\n" +
	"\n" +
	"ServerConf\x12\x18\n" +
	...
	"\x14pattern_data_handler\x18\x05 \x03(\v27.cloudprober.servers.http.ServerConf.PatternDataHandlerR\x12patternDataHandler\x1a`\n" +
	"\x12PatternDataHandler\x12#\n" +
	"\rresponse_size\x18\x01 \x02(\x05R\fresponseSize\x12%\n" +
	"\apattern\x18\x02 \x01(\t:\vcloudproberR\apattern\"#\n" +
	"\fProtocolType\x12\b\n" +
	"\x04HTTP\x10\x00\x12\t\n" +
