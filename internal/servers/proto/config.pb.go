...
const file_github_com_cloudprober_cloudprober_internal_servers_proto_config_proto_rawDesc = "" +
	"\n" +
	"Fgithub.com/cloudprober/cloudprober/internal/servers/proto/config.proto\x12\x13cloudprober.servers\x1aKgithub.com/cloudprober/cloudprober/internal/servers/grpc/proto/config.proto\x1aKgithub.com/cloudprober/cloudprober/internal/servers/http/proto/config.proto\x1aJgithub.com/cloudprober/cloudprober/internal/servers/udp/proto/config.proto\x1aOgithub.com/cloudprober/cloudprober/internal/servers/external/proto/config.proto\"\xae\x03\n" +
	"\tServerDef\x127\n" +
	"\x04type\x18\x01 \x02(\x0e2#.cloudprober.servers.ServerDef.TypeR\x04type\x12G\n" +
	"\vhttp_server\x18\x02 \x01(\v2$.cloudprober.servers.http.ServerConfH\x00R\n" +
	"httpServer\x12D\n" +
	"\n" +
	"udp_server\x18\x03 \x01(\v2#.cloudprober.servers.udp.ServerConfH\x00R\tudpServer\x12G\n" +
	"\vgrpc_server\x18\x04 \x01(\v2$.cloudprober.servers.grpc.ServerConfH\x00R\n" +
	"grpcServer\x12S\n" +
	"\x0fexternal_server\x18\x05 \x01(\v2(.cloudprober.servers.external.ServerConfH\x00R\x0eexternalServer\"1\n" +
	"\x04Type\x12\b\n" +
	"\x04HTTP\x10\x00\x12\a\n" +
	"\x03UDP\x10\x01\x12\b\n" +
	"\x04GRPC\x10\x02\x12\f\n" +
	"\bEXTERNAL\x10\x03B\b\n" +
	"\x06serverB;Z9github.com/cloudprober/cloudprober/internal/servers/proto"

var (
	file_github_com_cloudprober_cloudprober_internal_servers_proto_config_proto_rawDescOnce sync.Once
	file_github_com_cloudprober_cloudprober_internal_servers_proto_config_proto_rawDescData []byte
)
...
func file_github_com_cloudprober_cloudprober_internal_servers_proto_config_proto_rawDescGZIP() []byte {
	file_github_com_cloudprober_cloudprober_internal_servers_proto_config_proto_rawDescOnce.Do(func() {
		file_github_com_cloudprober_cloudprober_internal_servers_proto_config_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_github_com_cloudprober_cloudprober_internal_servers_proto_config_proto_rawDesc), len(file_github_com_cloudprober_cloudprober_internal_servers_proto_config_proto_rawDesc)))
	})
...
func file_github_com_cloudprober_cloudprober_internal_servers_proto_config_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_github_com_cloudprober_cloudprober_internal_servers_proto_config_proto_rawDesc), len(file_github_com_cloudprober_cloudprober_internal_servers_proto_config_proto_rawDesc)),
			NumEnums:      1,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
