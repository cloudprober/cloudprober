...
// 	protoc        v3.12.4
// source: internal/surfacers/bigquery/proto/config.proto
...
func (x *SurfacerConf) Reset() {
	*x = SurfacerConf{}
	mi := &file_internal_surfacers_bigquery_proto_config_proto_msgTypes[0]
...
func (*SurfacerConf) Descriptor() ([]byte, []int) {
	return file_internal_surfacers_bigquery_proto_config_proto_rawDescGZIP(), []int{0}
}
...
func (x *BQColumn) Reset() {
	*x = BQColumn{}
	mi := &file_internal_surfacers_bigquery_proto_config_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*BQColumn) Descriptor() ([]byte, []int) {
	return file_internal_surfacers_bigquery_proto_config_proto_rawDescGZIP(), []int{1}
}
...
var File_internal_surfacers_bigquery_proto_config_proto protoreflect.FileDescriptor

const file_internal_surfacers_bigquery_proto_config_proto_rawDesc = "" +
	"\n" +
	".internal/surfacers/bigquery/proto/config.proto\x12\x1dcloudprober.surfacer.bigquery\"\x86\x05\n" +
	"\fSurfacerConf\x12!\n" +
...
var (
	file_internal_surfacers_bigquery_proto_config_proto_rawDescOnce sync.Once
	file_internal_surfacers_bigquery_proto_config_proto_rawDescData []byte
)

func file_internal_surfacers_bigquery_proto_config_proto_rawDescGZIP() []byte {
	file_internal_surfacers_bigquery_proto_config_proto_rawDescOnce.Do(func() {
		file_internal_surfacers_bigquery_proto_config_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_internal_surfacers_bigquery_proto_config_proto_rawDesc), len(file_internal_surfacers_bigquery_proto_config_proto_rawDesc)))
	})
	return file_internal_surfacers_bigquery_proto_config_proto_rawDescData
}

var file_internal_surfacers_bigquery_proto_config_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_internal_surfacers_bigquery_proto_config_proto_goTypes = []any{
	(*SurfacerConf)(nil), // 0: cloudprober.surfacer.bigquery.SurfacerConf
	(*BQColumn)(nil),     // 1: cloudprober.surfacer.bigquery.BQColumn
}
var file_internal_surfacers_bigquery_proto_config_proto_depIdxs = []int32{
...
func init() { file_internal_surfacers_bigquery_proto_config_proto_init() }
func file_internal_surfacers_bigquery_proto_config_proto_init() {
	if File_internal_surfacers_bigquery_proto_config_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_internal_surfacers_bigquery_proto_config_proto_rawDesc), len(file_internal_surfacers_bigquery_proto_config_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_internal_surfacers_bigquery_proto_config_proto_goTypes,
		DependencyIndexes: file_internal_surfacers_bigquery_proto_config_proto_depIdxs,
		MessageInfos:      file_internal_surfacers_bigquery_proto_config_proto_msgTypes,
	}.Build()
	File_internal_surfacers_bigquery_proto_config_proto = out.File
	file_internal_surfacers_bigquery_proto_config_proto_goTypes = nil
	file_internal_surfacers_bigquery_proto_config_proto_depIdxs = nil
}
