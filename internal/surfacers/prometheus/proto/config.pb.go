...
var (
	...
	file_github_com_cloudprober_cloudprober_internal_surfacers_prometheus_proto_config_proto_rawDescData []byte
)
...
func file_github_com_cloudprober_cloudprober_internal_surfacers_prometheus_proto_config_proto_rawDescGZIP() []byte {
	file_github_com_cloudprober_cloudprober_internal_surfacers_prometheus_proto_config_proto_rawDescOnce.Do(func() {
		file_github_com_cloudprober_cloudprober_internal_surfacers_prometheus_proto_config_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_github_com_cloudprober_cloudprober_internal_surfacers_prometheus_proto_config_proto_rawDesc), len(file_github_com_cloudprober_cloudprober_internal_surfacers_prometheus_proto_config_proto_rawDesc)))
	})
...
var file_github_com_cloudprober_cloudprober_internal_surfacers_prometheus_proto_config_proto_goTypes = []any{
...
func file_github_com_cloudprober_cloudprober_internal_surfacers_prometheus_proto_config_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_github_com_cloudprober_cloudprober_internal_surfacers_prometheus_proto_config_proto_rawDesc), len(file_github_com_cloudprober_cloudprober_internal_surfacers_prometheus_proto_config_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
