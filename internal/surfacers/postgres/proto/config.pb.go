...
const file_github_com_cloudprober_cloudprober_internal_surfacers_postgres_proto_config_proto_rawDesc = "" +
	"\n" +
	"Qgithub.com/cloudprober/cloudprober/internal/surfacers/postgres/proto/config.proto\x12\x1dcloudprober.surfacer.postgres\"\xd2\x02\n" +
	"\fSurfacerConf\x12+\n" +
	...
	"\x06column\x18\x02 \x02(\tR\x06columnBFZDgithub.com/cloudprober/cloudprober/internal/surfacers/postgres/proto"

var (
	file_github_com_cloudprober_cloudprober_internal_surfacers_postgres_proto_config_proto_rawDescOnce sync.Once
	file_github_com_cloudprober_cloudprober_internal_surfacers_postgres_proto_config_proto_rawDescData []byte
)
...
func file_github_com_cloudprober_cloudprober_internal_surfacers_postgres_proto_config_proto_rawDescGZIP() []byte {
	file_github_com_cloudprober_cloudprober_internal_surfacers_postgres_proto_config_proto_rawDescOnce.Do(func() {
		file_github_com_cloudprober_cloudprober_internal_surfacers_postgres_proto_config_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_github_com_cloudprober_cloudprober_internal_surfacers_postgres_proto_config_proto_rawDesc), len(file_github_com_cloudprober_cloudprober_internal_surfacers_postgres_proto_config_proto_rawDesc)))
	})
...
var file_github_com_cloudprober_cloudprober_internal_surfacers_postgres_proto_config_proto_goTypes = []any{
...
func file_github_com_cloudprober_cloudprober_internal_surfacers_postgres_proto_config_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_github_com_cloudprober_cloudprober_internal_surfacers_postgres_proto_config_proto_rawDesc), len(file_github_com_cloudprober_cloudprober_internal_surfacers_postgres_proto_config_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
