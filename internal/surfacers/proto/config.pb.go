...
const file_github_com_cloudprober_cloudprober_internal_surfacers_proto_config_proto_rawDesc = "" +
	"\n" +
	"Hgithub.com/cloudprober/cloudprober/internal/surfacers/proto/config.proto\x12\x14cloudprober.surfacer\x1aSgithub.com/cloudprober/cloudprober/internal/surfacers/cloudwatch/proto/config.proto\x1aOgithub.com/cloudprober/cloudprober/internal/surfacers/consul/proto/config.proto\x1aPgithub.com/cloudprober/cloudprober/internal/surfacers/datadog/proto/config.proto\x1aMgithub.com/cloudprober/cloudprober/internal/surfacers/file/proto/config.proto\x1aMgithub.com/cloudprober/cloudprober/internal/surfacers/otel/proto/config.proto\x1aQgithub.com/cloudprober/cloudprober/internal/surfacers/postgres/proto/config.proto\x1aTgithub.com/cloudprober/cloudprober/internal/surfacers/probestatus/proto/config.proto\x1aSgithub.com/cloudprober/cloudprober/internal/surfacers/prometheus/proto/config.proto\x1aOgithub.com/cloudprober/cloudprober/internal/surfacers/pubsub/proto/config.proto\x1aTgithub.com/cloudprober/cloudprober/internal/surfacers/stackdriver/proto/config.proto\x1aQgithub.com/cloudprober/cloudprober/internal/surfacers/bigquery/proto/config.proto\"5\n" +
	"\vLabelFilter\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12\x14\n" +
	"\x05value\x18\x02 \x01(\tR\x05value\"\xb1\r\n" +
	...
	"\rotel_surfacer\x18\x13 \x01(\v2'.cloudprober.surfacer.otel.SurfacerConfH\x00R\fotelSurfacer\x12T\n" +
	"\x0fconsul_surfacer\x18\x14 \x01(\v2).cloudprober.surfacer.consul.SurfacerConfH\x00R\x0econsulSurfacer*\t\b\xc8\x01\x10\x80\x80\x80\x80\x02B\n" +
	"\n" +
	"\bsurfacer*\xc8\x01\n" +
	"\x04Type\x12\b\n" +
	...
	"\fUSER_DEFINED\x10cB=Z;github.com/cloudprober/cloudprober/internal/surfacers/proto"

var (
	file_github_com_cloudprober_cloudprober_internal_surfacers_proto_config_proto_rawDescOnce sync.Once
	file_github_com_cloudprober_cloudprober_internal_surfacers_proto_config_proto_rawDescData []byte
)
...
func file_github_com_cloudprober_cloudprober_internal_surfacers_proto_config_proto_rawDescGZIP() []byte {
	file_github_com_cloudprober_cloudprober_internal_surfacers_proto_config_proto_rawDescOnce.Do(func() {
		file_github_com_cloudprober_cloudprober_internal_surfacers_proto_config_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_github_com_cloudprober_cloudprober_internal_surfacers_proto_config_proto_rawDesc), len(file_github_com_cloudprober_cloudprober_internal_surfacers_proto_config_proto_rawDesc)))
	})
...
var file_github_com_cloudprober_cloudprober_internal_surfacers_proto_config_proto_goTypes = []any{
...
func file_github_com_cloudprober_cloudprober_internal_surfacers_proto_config_proto_init() {
	...
	file_github_com_cloudprober_cloudprober_internal_surfacers_proto_config_proto_msgTypes[1].OneofWrappers = []any{
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_github_com_cloudprober_cloudprober_internal_surfacers_proto_config_proto_rawDesc), len(file_github_com_cloudprober_cloudprober_internal_surfacers_proto_config_proto_rawDesc)),
			NumEnums:      1,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
