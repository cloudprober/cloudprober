...
const file_github_com_cloudprober_cloudprober_internal_rds_gcp_proto_config_proto_rawDesc = "" +
	"\n" +
	"Fgithub.com/cloudprober/cloudprober/internal/rds/gcp/proto/config.proto\x12\x13cloudprober.rds.gcp\"T\n" +
	"\fGCEInstances\x12\x1f\n" +
	"\vzone_filter\x18\x01 \x01(\tR\n" +
	"zoneFilter\x12#\n" +
	"\vre_eval_sec\x18b \x01(\x05:\x03300R\treEvalSec\"[\n" +
	"\x0fForwardingRules\x12#\n" +
	"\rregion_filter\x18\x01 \x01(\tR\fregionFilter\x12#\n" +
	"\vre_eval_sec\x18b \x01(\x05:\x03300R\treEvalSec\"\x9f\x01\n" +
	"\fRTCVariables\x12J\n" +
	"\n" +
	"rtc_config\x18\x01 \x03(\v2+.cloudprober.rds.gcp.RTCVariables.RTCConfigR\trtcConfig\x1aC\n" +
	"\tRTCConfig\x12\x12\n" +
	"\x04name\x18\x01 \x02(\tR\x04name\x12\"\n" +
	"\vre_eval_sec\x18\x02 \x01(\x05:\x0210R\treEvalSec\"\x87\x02\n" +
	"\x0ePubSubMessages\x12T\n" +
	"\fsubscription\x18\x01 \x03(\v20.cloudprober.rds.gcp.PubSubMessages.SubscriptionR\fsubscription\x12!\n" +
	"\fapi_endpoint\x18\x02 \x01(\tR\vapiEndpoint\x1a|\n" +
	"\fSubscription\x12\x12\n" +
	"\x04name\x18\x01 \x02(\tR\x04name\x12\x1d\n" +
	"\n" +
	"topic_name\x18\x02 \x01(\tR\ttopicName\x129\n" +
	"\x16seek_back_duration_sec\x18\x03 \x01(\x05:\x043600R\x13seekBackDurationSec\"\xc6\x03\n" +
	"\x0eProviderConfig\x12\x18\n" +
	"\aproject\x18\x01 \x03(\tR\aproject\x12F\n" +
	"\rgce_instances\x18\x02 \x01(\v2!.cloudprober.rds.gcp.GCEInstancesR\fgceInstances\x12O\n" +
	"\x10forwarding_rules\x18\x03 \x01(\v2$.cloudprober.rds.gcp.ForwardingRulesR\x0fforwardingRules\x12F\n" +
	"\rrtc_variables\x18\x04 \x01(\v2!.cloudprober.rds.gcp.RTCVariablesR\frtcVariables\x12L\n" +
	"\x0fpubsub_messages\x18\x05 \x01(\v2#.cloudprober.rds.gcp.PubSubMessagesR\x0epubsubMessages\x12#\n" +
	"\vapi_version\x18c \x01(\t:\x02v1R\n" +
	"apiVersion\x12F\n" +
	"\fapi_endpoint\x18d \x01(\t:#https://www.googleapis.com/compute/R\vapiEndpointB;Z9github.com/cloudprober/cloudprober/internal/rds/gcp/proto"

var (
	file_github_com_cloudprober_cloudprober_internal_rds_gcp_proto_config_proto_rawDescOnce sync.Once
	file_github_com_cloudprober_cloudprober_internal_rds_gcp_proto_config_proto_rawDescData []byte
)
...
func file_github_com_cloudprober_cloudprober_internal_rds_gcp_proto_config_proto_rawDescGZIP() []byte {
	file_github_com_cloudprober_cloudprober_internal_rds_gcp_proto_config_proto_rawDescOnce.Do(func() {
		file_github_com_cloudprober_cloudprober_internal_rds_gcp_proto_config_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_github_com_cloudprober_cloudprober_internal_rds_gcp_proto_config_proto_rawDesc), len(file_github_com_cloudprober_cloudprober_internal_rds_gcp_proto_config_proto_rawDesc)))
	})
...
func file_github_com_cloudprober_cloudprober_internal_rds_gcp_proto_config_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_github_com_cloudprober_cloudprober_internal_rds_gcp_proto_config_proto_rawDesc), len(file_github_com_cloudprober_cloudprober_internal_rds_gcp_proto_config_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   7,
			NumExtensions: 0,
			NumServices:   0,
