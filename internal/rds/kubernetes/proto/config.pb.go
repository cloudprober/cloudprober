...
func file_github_com_cloudprober_cloudprober_internal_rds_kubernetes_proto_config_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_github_com_cloudprober_cloudprober_internal_rds_kubernetes_proto_config_proto_msgTypes[0].Exporter = func(v any, i int) any {
			switch v := v.(*Pods); i {
			case 0:
				return &v.state
			case 1:
		...
		file_github_com_cloudprober_cloudprober_internal_rds_kubernetes_proto_config_proto_msgTypes[1].Exporter = func(v any, i int) any {
		...
		file_github_com_cloudprober_cloudprober_internal_rds_kubernetes_proto_config_proto_msgTypes[2].Exporter = func(v any, i int) any {
		...
		file_github_com_cloudprober_cloudprober_internal_rds_kubernetes_proto_config_proto_msgTypes[3].Exporter = func(v any, i int) any {
		...
		file_github_com_cloudprober_cloudprober_internal_rds_kubernetes_proto_config_proto_msgTypes[4].Exporter = func(v any, i int) any {
