...
type JSONMetric struct {
	...
	// Metric name that we should create from the JSON. To define a metric name
	// from JSON, specify name_jq_filter.
	//
	// Types that are assignable to Name:
	//
	//	*JSONMetric_MetricName
...
func (m *JSONMetric) GetName() isJSONMetric_Name {
	if m != nil {
		return m.Name
	}
	return nil
...
func (x *JSONMetric) GetMetricName() string {
	if x, ok := x.GetName().(*JSONMetric_MetricName); ok {
		return x.MetricName
	}
	return ""
}

func (x *JSONMetric) GetNameJqFilter() string {
	if x, ok := x.GetName().(*JSONMetric_NameJqFilter); ok {
		return x.NameJqFilter
	}
	return ""
}

func (x *JSONMetric) GetValueJqFilter() string {
	if x != nil && x.ValueJqFilter != nil {
		return *x.ValueJqFilter
	}
	return ""
}
...
type isJSONMetric_Name interface {
	isJSONMetric_Name()
}

type JSONMetric_MetricName struct {
	MetricName string `protobuf:"bytes,1,opt,name=metric_name,json=metricName,oneof"`
}

type JSONMetric_NameJqFilter struct {
	// JQ filter to extract the metric name from JSON. JQ filter should extract
	// a string.
	NameJqFilter string `protobuf:"bytes,2,opt,name=name_jq_filter,json=nameJqFilter,oneof"`
}

func (*JSONMetric_MetricName) isJSONMetric_Name() {}

func (*JSONMetric_NameJqFilter) isJSONMetric_Name() {}
...
type OutputMetricsOptions struct {
	...
	//
	//	json_metric {
	//	  metric_name: "backend_latency"
	//	  value_jq_filter: ".backend.latency"
	//	}
...
var file_github_com_cloudprober_cloudprober_metrics_payload_proto_config_proto_rawDesc = []byte{
	...
	0x50, 0x5f, 0x54, 0x49, 0x4d, 0x45, 0x10, 0x04, 0x22, 0xb1, 0x01, 0x0a, 0x0a, 0x4a, 0x53, 0x4f,
	...
	,
	...
	,
	...
	,
	...
	0x65, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x19, 0x2e, 0x63, 0x6c, 0x6f, 0x75, 0x64, 0x70,
	...
	0x0b, 0x4d, 0x65, 0x74, 0x72, 0x69, 0x63, 0x73, 0x4b, 0x69, 0x6e, 0x64, 0x12, 0x0d, 0x0a, 0x09,
	0x55, 0x4e, 0x44, 0x45, 0x46, 0x49, 0x4e, 0x45, 0x44, 0x10, 0x00, 0x12, 0x09, 0x0a, 0x05, 0x47,
	0x41, 0x55, 0x47, 0x45, 0x10, 0x01, 0x12, 0x0e, 0x0a, 0x0a, 0x43, 0x55, 0x4d, 0x55, 0x4c, 0x41,
	0x54, 0x49, 0x56, 0x45, 0x10, 0x02, 0x42, 0x3a, 0x5a, 0x38, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62,
...
func file_github_com_cloudprober_cloudprober_metrics_payload_proto_config_proto_init() {
	...
	file_github_com_cloudprober_cloudprober_metrics_payload_proto_config_proto_msgTypes[1].OneofWrappers = []any{
		(*JSONMetric_MetricName)(nil),
		(*JSONMetric_NameJqFilter)(nil),
	}
	type x struct{}
