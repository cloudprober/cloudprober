...
type JSONMetric struct {
	...
	// JQ filter to extract metrics from JSON. JQ filter should extract a map of
	// type map[string]any and each entry in the map is converted to a metric.
	// Map values can be a string, number, or a bool.
	MetricsJqFilter *string `protobuf:"bytes,1,opt,name=metrics_jq_filter,json=metricsJqFilter" json:"metrics_jq_filter,omitempty"`
	// Metric name. Note: this option is valid only if metrics_jq_filter is not
	// specified. Also, for this to work, value_jq_filter must be specified.
	MetricName *string `protobuf:"bytes,2,opt,name=metric_name,json=metricName" json:"metric_name,omitempty"`
	// JQ filter to extract metric value from JSON. Note: this option is valid
	// only if `metric_name` is specified and `metrics_jq_filter` is not.
	ValueJqFilter *string `protobuf:"bytes,3,opt,name=value_jq_filter,json=valueJqFilter" json:"value_jq_filter,omitempty"`
...
func (x *JSONMetric) GetMetricsJqFilter() string {
	if x != nil && x.MetricsJqFilter != nil {
		return *x.MetricsJqFilter
	}
	return ""
}
...
var file_github_com_cloudprober_cloudprober_metrics_payload_proto_config_proto_rawDesc = []byte{
	...
	,
	...
	,
	...
	0x6d, 0x65, 0x74, 0x72, 0x69, 0x63, 0x73, 0x2e, 0x44, 0x69, 0x73, 0x74, 0x52, 0x05, 0x76, 0x61,
	0x6c, 0x75, 0x65, 0x3a, 0x02, 0x38, 0x01, 0x22, 0x37, 0x0a, 0x0b, 0x4d, 0x65, 0x74, 0x72, 0x69,
	0x63, 0x73, 0x4b, 0x69, 0x6e, 0x64, 0x12, 0x0d, 0x0a, 0x09, 0x55, 0x4e, 0x44, 0x45, 0x46, 0x49,
	0x4e, 0x45, 0x44, 0x10, 0x00, 0x12, 0x09, 0x0a, 0x05, 0x47, 0x41, 0x55, 0x47, 0x45, 0x10, 0x01,
	0x12, 0x0e, 0x0a, 0x0a, 0x43, 0x55, 0x4d, 0x55, 0x4c, 0x41, 0x54, 0x49, 0x56, 0x45, 0x10, 0x02,
	...
	0x61, 0x79, 0x6c, 0x6f, 0x61, 0x64, 0x2f, 0x70, 0x72, 0x6f, 0x74, 0x6f,
}
