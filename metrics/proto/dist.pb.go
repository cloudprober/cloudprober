...
func file_github_com_cloudprober_cloudprober_metrics_proto_dist_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_github_com_cloudprober_cloudprober_metrics_proto_dist_proto_msgTypes[0].Exporter = func(v any, i int) any {
			switch v := v.(*Dist); i {
			case 0:
				return &v.state
			case 1:
		...
		file_github_com_cloudprober_cloudprober_metrics_proto_dist_proto_msgTypes[1].Exporter = func(v any, i int) any {
