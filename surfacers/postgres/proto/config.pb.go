...
type SurfacerConf struct {
	...
	LabelsToColumn    *LabelsToColumn `protobuf:"bytes,4,opt,name=labels_to_column,json=labelsToColumn" json:"labels_to_column,omitempty"`
...
func (x *SurfacerConf) GetLabelsToColumn() *LabelsToColumn {
	if x != nil {
		return x.LabelsToColumn
	}
	return nil
}
...
type LabelsToColumn struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	LabelToColumn []*LabelToColumn `protobuf:"bytes,1,rep,name=label_to_column,json=labelToColumn" json:"label_to_column,omitempty"`
}

func (x *LabelsToColumn) Reset() {
	*x = LabelsToColumn{}
	if protoimpl.UnsafeEnabled {
...
func (x *LabelsToColumn) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*LabelsToColumn) ProtoMessage() {}

func (x *LabelsToColumn) ProtoReflect() protoreflect.Message {
	mi := &file_github_com_cloudprober_cloudprober_surfacers_postgres_proto_config_proto_msgTypes[1]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use LabelsToColumn.ProtoReflect.Descriptor instead.
func (*LabelsToColumn) Descriptor() ([]byte, []int) {
	return file_github_com_cloudprober_cloudprober_surfacers_postgres_proto_config_proto_rawDescGZIP(), []int{1}
}

func (x *LabelsToColumn) GetLabelToColumn() []*LabelToColumn {
	if x != nil {
...
func (x *LabelToColumn) Reset() {
	*x = LabelToColumn{}
	if protoimpl.UnsafeEnabled {
		mi := &file_github_com_cloudprober_cloudprober_surfacers_postgres_proto_config_proto_msgTypes[2]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*LabelToColumn) Descriptor() ([]byte, []int) {
	return file_github_com_cloudprober_cloudprober_surfacers_postgres_proto_config_proto_rawDescGZIP(), []int{2}
}
...
var file_github_com_cloudprober_cloudprober_surfacers_postgres_proto_config_proto_rawDesc = []byte{
	...
	0x2e, 0x70, 0x6f, 0x73, 0x74, 0x67, 0x72, 0x65, 0x73, 0x22, 0xf9, 0x01, 0x0a, 0x0c, 0x53, 0x75,
	...
	,
	...
	0x20, 0x02, 0x28, 0x09, 0x52, 0x06, 0x63, 0x6f, 0x6c, 0x75, 0x6d, 0x6e, 0x42, 0x3d, 0x5a, 0x3b,
	...
	0x74, 0x67, 0x72, 0x65, 0x73, 0x2f, 0x70, 0x72, 0x6f, 0x74, 0x6f,
}
...
var file_github_com_cloudprober_cloudprober_surfacers_postgres_proto_config_proto_msgTypes = make([]protoimpl.MessageInfo, 3)
var file_github_com_cloudprober_cloudprober_surfacers_postgres_proto_config_proto_goTypes = []interface{}{
	...
	(*LabelsToColumn)(nil), // 1: cloudprober.surfacer.postgres.LabelsToColumn
	(*LabelToColumn)(nil),  // 2: cloudprober.surfacer.postgres.LabelToColumn
}
var file_github_com_cloudprober_cloudprober_surfacers_postgres_proto_config_proto_depIdxs = []int32{
	1, // 0: cloudprober.surfacer.postgres.SurfacerConf.labels_to_column:type_name -> cloudprober.surfacer.postgres.LabelsToColumn
	2, // 1: cloudprober.surfacer.postgres.LabelsToColumn.label_to_column:type_name -> cloudprober.surfacer.postgres.LabelToColumn
...
func file_github_com_cloudprober_cloudprober_surfacers_postgres_proto_config_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_github_com_cloudprober_cloudprober_surfacers_postgres_proto_config_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
