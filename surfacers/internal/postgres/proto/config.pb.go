...
type SurfacerConf struct {
	...
	MetricsBatchMinimumFlushSize *int64 `protobuf:"varint,5,opt,name=metrics_batch_minimum_flush_size,json=metricsBatchMinimumFlushSize" json:"metrics_batch_minimum_flush_size,omitempty"`
	// Maximum interval between flushes, in milliseconds. Every time batch is
	// flushed, this timer is reset. Default value is 1000.
	MetricsBatchFlushIntervalMsec *int64 `protobuf:"varint,6,opt,name=metrics_batch_flush_interval_msec,json=metricsBatchFlushIntervalMsec" json:"metrics_batch_flush_interval_msec,omitempty"`
}
...
func (x *SurfacerConf) GetMetricsBatchMinimumFlushSize() int64 {
	if x != nil && x.MetricsBatchMinimumFlushSize != nil {
		return *x.MetricsBatchMinimumFlushSize
	}
	return 0
}

func (x *SurfacerConf) GetMetricsBatchFlushIntervalMsec() int64 {
	if x != nil && x.MetricsBatchFlushIntervalMsec != nil {
		return *x.MetricsBatchFlushIntervalMsec
	}
	return 0
}
...
var file_github_com_cloudprober_cloudprober_surfacers_internal_postgres_proto_config_proto_rawDesc = []byte{
	...
	0x65, 0x73, 0x22, 0x88, 0x03, 0x0a, 0x0c, 0x53, 0x75, 0x72, 0x66, 0x61, 0x63, 0x65, 0x72, 0x43,
	...
	,
	...
	0x65, 0x72, 0x6e, 0x61, 0x6c, 0x2f, 0x70, 0x6f, 0x73, 0x74, 0x67, 0x72, 0x65, 0x73, 0x2f, 0x70,
	0x72, 0x6f, 0x74, 0x6f,
}
...
var file_github_com_cloudprober_cloudprober_surfacers_internal_postgres_proto_config_proto_goTypes = []interface{}{
...
func file_github_com_cloudprober_cloudprober_surfacers_internal_postgres_proto_config_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_github_com_cloudprober_cloudprober_surfacers_internal_postgres_proto_config_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_github_com_cloudprober_cloudprober_surfacers_internal_postgres_proto_config_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
