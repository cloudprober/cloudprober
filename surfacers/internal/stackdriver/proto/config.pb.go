...
type SurfacerConf struct {
	...
	// stackdriver.
	DisableDataOverwrite *bool `protobuf:"varint,7,opt,name=disable_data_overwrite,json=disableDataOverwrite,def=0" json:"disable_data_overwrite,omitempty"`
}
...
const (
	...
	Default_SurfacerConf_DisableDataOverwrite = bool(false)
)
...
func (x *SurfacerConf) GetDisableDataOverwrite() bool {
	if x != nil && x.DisableDataOverwrite != nil {
		return *x.DisableDataOverwrite
	}
	return Default_SurfacerConf_DisableDataOverwrite
}
...
var file_github_com_cloudprober_cloudprober_surfacers_internal_stackdriver_proto_config_proto_rawDesc = []byte{
	...
	0x63, 0x6b, 0x64, 0x72, 0x69, 0x76, 0x65, 0x72, 0x22, 0xee, 0x03, 0x0a, 0x0c, 0x53, 0x75, 0x72,
	...
	,
