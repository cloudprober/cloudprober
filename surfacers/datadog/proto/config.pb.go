...
type SurfacerConf struct {
	...
	Compress *bool `protobuf:"varint,7,opt,name=compress,def=1" json:"compress,omitempty"`
}

// Default values for SurfacerConf fields.
const (
	Default_SurfacerConf_Prefix   = string("cloudprober")
	Default_SurfacerConf_Compress = bool(true)
)
...
func (x *SurfacerConf) GetCompress() bool {
	if x != nil && x.Compress != nil {
		return *x.Compress
	}
	return Default_SurfacerConf_Compress
}
...
var file_github_com_cloudprober_cloudprober_surfacers_datadog_proto_config_proto_rawDesc = []byte{
	...
	0x64, 0x61, 0x74, 0x61, 0x64, 0x6f, 0x67, 0x22, 0x9f, 0x01, 0x0a, 0x0c, 0x53, 0x75, 0x72, 0x66,
	...
	0x06, 0x73, 0x65, 0x72, 0x76, 0x65, 0x72, 0x12, 0x20, 0x0a, 0x08, 0x63, 0x6f, 0x6d, 0x70, 0x72,
	0x65, 0x73, 0x73, 0x18, 0x07, 0x20, 0x01, 0x28, 0x08, 0x3a, 0x04, 0x74, 0x72, 0x75, 0x65, 0x52,
	0x08, 0x63, 0x6f, 0x6d, 0x70, 0x72, 0x65, 0x73, 0x73, 0x42, 0x3c, 0x5a, 0x3a, 0x67, 0x69, 0x74,
