...
type SurfacerConf struct {
	...
	// Maximum number of points to keep. This field dictates the memory used.
	MaxPoints *int32 `protobuf:"varint,2,opt,name=max_points,json=maxPoints,def=4320" json:"max_points,omitempty"`
	// ProbeStatus URL
	Url *string `protobuf:"bytes,3,opt,name=url,def=/probestatus" json:"url,omitempty"`
}

// Default values for SurfacerConf fields.
const (
	Default_SurfacerConf_ResolutionSec = int32(60)
	Default_SurfacerConf_MaxPoints     = int32(4320)
	Default_SurfacerConf_Url           = string("/probestatus")
)
...
func (x *SurfacerConf) GetMaxPoints() int32 {
	if x != nil && x.MaxPoints != nil {
		return *x.MaxPoints
	}
	return Default_SurfacerConf_MaxPoints
}
...
var file_github_com_cloudprober_cloudprober_surfacers_probestatus_proto_config_proto_rawDesc = []byte{
	...
	,
