...
type SurfacerConf struct {
	...
	Columns           []*BQColumn `protobuf:"bytes,5,rep,name=columns" json:"columns,omitempty"`
	...
	BatchInsertionTime *int64 `protobuf:"varint,6,opt,name=batch_insertion_time,json=batchInsertionTime,def=10" json:"batch_insertion_time,omitempty"`
	...
	BigqueryTimeout *int64 `protobuf:"varint,7,opt,name=bigquery_timeout,json=bigqueryTimeout,def=30" json:"bigquery_timeout,omitempty"`
}

// Default values for SurfacerConf fields.
const (
	Default_SurfacerConf_MetricsBufferSize  = int64(100000)
	Default_SurfacerConf_BatchInsertionTime = int64(10)
	Default_SurfacerConf_BigqueryTimeout    = int64(30)
)
...
func (x *SurfacerConf) GetColumns() []*BQColumn {
	if x != nil {
		return x.Columns
	}
	return nil
...
func (x *SurfacerConf) GetBatchInsertionTime() int64 {
	if x != nil && x.BatchInsertionTime != nil {
		return *x.BatchInsertionTime
	}
	return Default_SurfacerConf_BatchInsertionTime
}

func (x *SurfacerConf) GetBigqueryTimeout() int64 {
	if x != nil && x.BigqueryTimeout != nil {
		return *x.BigqueryTimeout
	}
	return Default_SurfacerConf_BigqueryTimeout
}
...
var file_github_com_cloudprober_cloudprober_surfacers_bigquery_proto_config_proto_rawDesc = []byte{
	...
	0x2e, 0x62, 0x69, 0x67, 0x71, 0x75, 0x65, 0x72, 0x79, 0x22, 0xe3, 0x02, 0x0a, 0x0c, 0x53, 0x75,
	...
	,
	...
	0x65, 0x72, 0x73, 0x2f, 0x62, 0x69, 0x67, 0x71, 0x75, 0x65, 0x72, 0x79, 0x2f, 0x70, 0x72, 0x6f,
	0x74, 0x6f,
}
...
var file_github_com_cloudprober_cloudprober_surfacers_bigquery_proto_config_proto_depIdxs = []int32{
	1, // 0: cloudprober.surfacer.bigquery.SurfacerConf.columns:type_name -> cloudprober.surfacer.bigquery.BQColumn
